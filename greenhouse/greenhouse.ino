...
unsigned long mainMenu() {
  ...
  tft.println();
  tft.println("Moisture lvls  ");
  tft.fillRect(0, 110, 70, 120, ILI9341_WHITE);
  tft.println(sensor1Value);
  tft.println(sensor2Value);
...
unsigned long testText() {
  ...
  tft.setTextSize(5);
  tft.println("Groop");
  tft.setTextSize(2);#include "SPI.h"
#include "Adafruit_GFX.h"
#include "Adafruit_ILI9341.h"
#include "FastLED.h"
